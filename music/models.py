...
class Artist(models.Model):
    ...
    image = models.ImageField(upload_to='music/', height_field='image_width', width_field='image_height', blank=True)
...
class Album(models.Model):
    ...
    cover = models.ImageField(upload_to='music/', height_field='cover_height', width_field='cover_width', blank=True)
