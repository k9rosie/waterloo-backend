"""
Django settings for waterloomusic_backend project.
...
SECRET_KEY = 'lorem ipsum' if ENVIRONMENT == 'development' else os.environ['SECRET_KEY']
...
ROOT_URLCONF = 'waterloomusic_backend.urls'
